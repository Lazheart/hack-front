    ...
    <footer style={{borderTop: '1px solid rgba(255,255,255,0.06)', padding: '1.5rem 0', background: 'var(--bg-black)'}}>
      <div className="footer-inner">
        <div className="footer-left">
          <img src={LogoImage} alt="logo" style={{height: 44}} />
        </div>
        ...
        <div className="footer-center">
          ...
          <div style={{display: 'flex', gap: '1rem', justifyContent: 'center', marginTop: '0.5rem', flexWrap: 'wrap'}}>
            {collaborators.map((c) => (
              <a key={c.href} href={c.href} target="_blank" rel="noreferrer" style={{color: 'var(--text-white)', textDecoration: 'none', display: 'flex', gap: '.5rem', alignItems: 'center'}}>
                <BsGithub />
        ...
        <div className="footer-right" style={{color: 'rgba(255,255,255,0.85)'}}>
          <a href="https://github.com/Lazheart/cloud-hackaton" target="_blank" rel="noreferrer" style={{color: 'var(--text-white)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '.5rem'}}>
            <BsGithub />
